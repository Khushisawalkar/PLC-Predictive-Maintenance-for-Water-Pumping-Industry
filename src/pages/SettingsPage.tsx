          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="flex flex-col gap-3">
               <div className="flex justify-between items-center border-b border-[#1e2d3d] pb-2">
                <span className="text-xs font-mono text-[#c0d0e0]">Temperature (°C)</span>
              ...
              <div className="flex justify-between items-center border-b border-[#1e2d3d] pb-2">
                <span className="text-xs font-mono text-[#c0d0e0]">Vibration (mm/s)</span>
                <div className="flex gap-2">
                  <input type="text" value="10" readOnly className="bg-[#1e2d3d]/50 border border-amber-500/30 rounded px-2 py-1 text-xs font-mono text-amber-400 w-12 text-center" title="Warning" />
                  <input type="text" value="15" readOnly className="bg-[#1e2d3d]/50 border border-red-500/30 rounded px-2 py-1 text-xs font-mono text-red-400 w-12 text-center" title="Fault" />
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-3">
